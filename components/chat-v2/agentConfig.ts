...
export const ARMY_AGENTS: AgentConfig[] = [
  ...
  },
  {
    ...
    longDescription: 'Janus is the uncompromising quality gatekeeper. He doesn\'t just run tests — he boots the app, navigates the UI, captures screenshots as proof, and verifies that every acceptance criterion is met. A Janus PASS means the work is genuinely done. A FAIL sends it back to Vulcan with detailed failure evidence.',
  ...
  },
  {
    ...
    longDescription: 'Minerva is the reconnaissance specialist deployed before the planning phase. He dives into documentation, explores API surfaces, benchmarks approaches, and surfaces the information Athena needs to make informed plans. Minerva turns unknowns into knowns.',
  ...
  },
  {
    ...
    longDescription: 'Cato is the one who takes Vulcan\'s working code and gets it running in production. From CI/CD pipelines to server provisioning, database migrations to performance tuning, Forge ensures that what works locally works everywhere. When something goes down at 3am, Cato is the first responder.',
  ...
  },
  {
    ...
    longDescription: 'Mercury is the team\'s connection to the outside world. From customer support and outreach emails to community engagement and trend monitoring, Mercury ensures the company stays connected with its users and aware of what\'s happening in its space. When someone needs to hear from us, Mercury carries the message.',
  ...
  },
  {
    ...
    longDescription: 'Cicero is the voice of the operation — turning technical complexity into compelling content. From documentation to social media posts, release announcements to marketing copy, Quill ensures every piece of communication is clear, engaging, and on-brand. When the team builds something great, Quill makes sure the world hears about it.',
