...
export const ARMY_AGENTS: AgentConfig[] = [
  ...
  },
  {
    ...
    longDescription: 'Hermes is the reconnaissance specialist deployed before the planning phase. He dives into documentation, explores API surfaces, benchmarks approaches, and surfaces the information Athena needs to make informed plans. Hermes turns unknowns into knowns.',
