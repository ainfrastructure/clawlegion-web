...
import type { RalphLoopSettingsProps, RalphLoopSettings as RalphLoopSettingsType } from '../types'

export function RalphLoopSettings({ settings, onChange }: RalphLoopSettingsProps) {
  ...
  const handleCheckpointChange = (checkpoints: RalphLoopSettingsType['checkpoints']) => {
...
export default RalphLoopSettings
