...
export function AgentDetailModal({ agent, isOpen, onClose, onDeleted }: AgentDetailModalProps) {
  ...
  const { data: soulData, isLoading: soulLoading, isError: soulError } = useSoul(openclawAgentId)
  const { data: agentsmdData, isLoading: agentsmdLoading, isError: agentsmdError } = useAgentsmd(openclawAgentId)
