...
import { SwissTaskCard } from '@/components/swiss/SwissTaskCard'
    ...
    <PageContainer>
      <div className="space-y-swiss-8">
        ...
        <SwissSection title="In Progress">
          <div className="flex justify-end mb-swiss-4">
            <Link href="/tasks" className="text-swiss-sm text-[var(--swiss-accent)] hover:underline flex items-center gap-swiss-1">
          ...
          {activeTasks.length === 0 ? (
            <SwissEmptyState
              ...
              action={{ label: 'Go to Work', onClick: () => window.location.href = '/tasks' }}
            />
          ) : (
        ...
        {recentlyCompleted.length > 0 && (
          <SwissSection title="Recently Done">
            <div className="space-y-swiss-2">
